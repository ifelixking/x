...
namespace Snipe
{
	class Sniper_list_xp1024 : Sniper
	{
		...
		private EntryPage[] m_entryList = new EntryPage[] {
			...
			new EntryPage(){ url ="http://1024.917rbb.pw/pw/thread.php?fid=5",  sniperCode = 1002, pathPage="div:#main/div:@3/table/tbody/tr/td:@0/div/div/a:@-1", tags = "亚洲无码" },
			new EntryPage(){ url ="http://1024.917rbb.pw/pw/thread.php?fid=22", sniperCode = 1003, pathPage="div:#main/div:@3/table/tbody/tr/td:@0/div/div/a:@-1", tags = "日本有码" },
			new EntryPage(){ url ="http://1024.917rbb.pw/pw/thread.php?fid=7",  sniperCode = 1004, pathPage="div:#main/div:@3/table/tbody/tr/td:@0/div/div/a:@-1", tags = "欧美无码" },
